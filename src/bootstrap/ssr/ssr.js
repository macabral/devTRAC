        ...
        function requireVue_cjs_prod() {
            ...
            (function (exports2) {
                ...
                var runtimeDom__namespace =
                    /* @__PURE__ */ _interopNamespaceDefault(runtimeDom);
                ...
                function compileToFunction(template, options) {
                    ...
                    if (
                        ...
                        opts.isCustomElement = (tag) =>
                            !!customElements.get(tag);
                    }
                    const { code } = compilerDom.compile(template, opts);
                    const render = new Function("Vue", code)(
                        runtimeDom__namespace
                    );
                    render._rc = true;
...
${codeFrame}`
        ...
        var ci = Object.prototype,
            ...
            aa = En(
                ...
                : function (e) {
                      return (
                          Le(e) && ia.call(e, "callee") && !sa.call(e, "callee")
                      );
                  };
        const di = aa;
        ...
        function ho(e) {
            $e ||
                ...
                ye("history:pushed-state", { url: e.url }));
        }
        function mo(e) {
            const t = Dr(
                e,
            ...
            $e ||
                ...
                ye("history:replaced-state", { url: t.url }));
        }
        function bi(e) {
            $e ||
                (window.history.replaceState(e, "", e.url),
                ye("history:replaced-state", { url: e.url }));
        }
        const ur = vueExports.ref(0),
            Nr = vueExports.ref(null);
        function vo(e) {
        ...
        function go(e, t, r) {
            ...
            if (
                (J((g = e.data) == null ? void 0 : g.splade) ||
                    console.error(
                        "The response is not a Splade response. Did you use the Splade Middleware on this route?"
                    ),
            ...
            if (
                (Hr(e.data.splade),
                Gt(e.data.splade.head),
                n === R.value.url && (t = true),
                e.data.splade.modal)
            )
            ...
            t
                ...
                : (l && Mt.value++,
                  (!l || !o) &&
                      (ie.value++,
                      (tt[ie.value] = tt[ie.value] || new yi(ie.value))));
            let u =
                    e.data.splade.persistentLayout &&
                    i === e.data.splade.persistentLayout,
                c = 0;
            !$e && e.data.splade.preserveScroll && (c = window.scrollY),
                Ur(
                    u ? R.value.html : s,
                    c,
        ...
        function Ke(e, t, r, n, i, s) {
            if (
                ($e || qi("scrollY", window.scrollY), t.toUpperCase() === "GET")
            ) {
            ...
            return (
                a
                    ...
                    .catch(async (o) => {
                        ...
                        if (
                            l.status == 409 &&
                            l.headers["x-splade-redirect-away"]
                        )
                        ...
                        if (l.data instanceof Blob) {
                            ...
                            l.data.type === "application/json" &&
                            typeof c == "string"
                                ? (u = JSON.parse(c) || {})
                                : (l.data.html = c);
                        } else u = l.data.splade;
                        u && !u.lazy && !u.rehydrate && Hr(u),
                            l.status != 422 &&
                                Pi(l.data.html ? l.data.html : l.data);
                    }),
                a
            );
        }
        ...
        function jo(e) {
            ...
            return (
                e && (t["X-Splade-Preserve-Scroll"] = true), Ci(R.value.url, t)
            );
        }
        function Mo(e, t) {
            tt[ie.value].on(e, t);
        ...
        function ye(e, t) {
            typeof t > "u" && (t = {}),
                tt[ie.value].emit(e, t),
                $e ||
                    document.dispatchEvent(
                        new CustomEvent(`splade:${e}`, { detail: t })
                    );
        }
        const p = {
            init: fo,
        ...
        const ue = {
                ...
                setup(e) {
                    ...
                    return (
                        vueExports.watch(() => t.html, n, { immediate: true }),
                        (i, s) =>
                            e.html
                                ? (vueExports.openBlock(),
                                  vueExports.createBlock(vueExports.unref(r), {
                                      key: 0,
                                  }))
            ...
            Vo = {
                ...
                setup(e, { emit: t }) {
                    ...
                    return (
                        vueExports.onMounted(() => i()),
                        (o, l) => (
                            vueExports.openBlock(),
                            vueExports.createElementBlock(
                                "div",
                                {
                                    style: {
                                        position: "fixed",
            ...
            Ho = {
                ...
                setup(e) {
                    ...
                    const r = vueExports.ref(),
                        n = vueExports.ref([]),
                        i = vueExports.ref(null),
                        s = vueExports.ref(null),
                        a = vueExports.ref(true),
                        o = vueExports.inject("$spladeOptions") || {},
                    ...
                    function g(h) {
                        ...
                        try {
                            (d = document.querySelector(m)) == null ||
                                d.remove();
                        } catch {}
                    }
                    p.setOnHead((h) => {
                        ...
                        (n.value = []),
                            ...
                            vueExports.nextTick(() => {
                                if (!p.isSsr) {
                                    ...
                                    d && document.getElementById(d.substring(1))
                    ...
                    return (
                        ...
                        (h, m) => (
                            vueExports.openBlock(),
                            vueExports.createElementBlock("div", null, [
                                vueExports.unref(p).isSsr
                                    ? (vueExports.openBlock(),
                                      vueExports.createBlock(
                                          ue,
                                          {
                                              key: `visit.${
                                                  vueExports.unref(p)
                                    ...
                                    : (vueExports.openBlock(),
                                      vueExports.createBlock(
                                          vueExports.KeepAlive,
                                          {
                                              key: 0,
                                              max: vueExports.unref(o)
                                                  .max_keep_alive,
                                          },
                                          [
                                              (vueExports.openBlock(),
                                ...
                                (vueExports.openBlock(true),
                                vueExports.createElementBlock(
                                    vueExports.Fragment,
                                    null,
                                    vueExports.renderList(
                                        vueExports.unref(p).currentStack.value,
                                        (d) => (
                                            vueExports.openBlock(),
                                            vueExports.createBlock(
                                                ue,
        ...
        function Xr(e, t) {
            ...
            return r == "number" ||
                ...
                Xt(e)
                ? true
                : Ko.test(e) || !Xo.test(e) || (t != null && e in Object(t));
        }
        ...
        function fe(e, t, ...r) {
            ...
            throw (
                (Error.captureStackTrace && Error.captureStackTrace(n, fe), n)
            );
        }
        var Dt = ((e) => (
                (e[(e.None = 0)] = "None"),
...
`)
                    ...
                    let f = Ri((a = v.props) != null ? a : {}, l),
                        h = vueExports.cloneVNode(v, f);
                    for (let m in f)
                        m.startsWith("on") &&
                            (h.props || (h.props = {}), (h.props[m] = f[m]));
                    return h;
                }
                return Array.isArray(u) && u.length === 1 ? u[0] : u;
            }
            return vueExports.h(o, Object.assign({}, l, c), {
                default: () => u,
            });
        }
        function Li(e) {
            return e.flatMap((t) =>
                t.type === vueExports.Fragment ? Li(t.children) : [t]
            );
        }
        function Ri(...e) {
        ...
        class Yl {
            ...
            set(t) {
                this.current !== t &&
                    ((this.currentId = 0), (this.current = t));
            }
            reset() {
        ...
        function eu(e = document.body) {
            return e == null
                ? []
                : Array.from(e.querySelectorAll(br)).sort((t, r) =>
                      Math.sign(
        ...
        function au(e, t, r = vueExports.computed(() => true)) {
            function n(s, a) {
                ...
                return (
                    !tu(o, Ni.Loose) && o.tabIndex !== -1 && s.preventDefault(),
                    t(s, o)
                );
            }
        ...
        let wr = vueExports.defineComponent({
            name: "Hidden",
            props: {
            ...
            Et.isServer ||
                vueExports.watchEffect((n) => {
                    window.addEventListener(e, t, r),
                        n(() => window.removeEventListener(e, t, r));
                });
        }
        var vt = ((e) => (
        ...
        function Vi(e, t, r, n) {
            Et.isServer ||
                vueExports.watchEffect((i) => {
                    (e = e ?? window),
                        e.addEventListener(t, r, n),
                        i(() => e.removeEventListener(t, r, n));
                });
        }
        function Hi(e) {
                ...
                vueExports.defineComponent({
                    ...
                    props: {
                        ...
                        containers: {
                            ...
                            default: vueExports.ref(/* @__PURE__ */ new Set()),
                        },
                    },
                    inheritAttrs: false,
                    setup(e, { attrs: t, slots: r, expose: n }) {
                        let i = vueExports.ref(null);
                        n({ el: i, $el: i });
                        let s = vueExports.computed(() => Tt(i)),
                            a = vueExports.ref(false);
                        vueExports.onMounted(() => (a.value = true)),
                            vueExports.onUnmounted(() => (a.value = false)),
                            fu(
                                { ownerDocument: s },
                                vueExports.computed(
                                    () => a.value && !!(e.features & 16)
                                )
                            );
                        let o = pu(
                            {
                                ownerDocument: s,
                                container: i,
                                initialFocus: vueExports.computed(
                                    () => e.initialFocus
                                ),
                            },
                            vueExports.computed(
                                () => a.value && !!(e.features & 2)
                            )
                        );
                        hu(
                            {
                        ...
                        return () => {
                            let f = {},
                                h = { ref: i, onKeydown: v, onFocusout: g },
                                {
                                    features: m,
                                    initialFocus: d,
                                    containers: b,
                            ...
                            return vueExports.h(vueExports.Fragment, [
                                !!(m & 4) &&
                                    vueExports.h(wr, {
                                        as: "button",
                                        type: "button",
        ...
        cu(() => {
            function e(t) {
                t.target instanceof HTMLElement &&
                    ...
                    He[0] !== t.target &&
                    (He.unshift(t.target),
                    (He = He.filter((r) => r != null && r.isConnected)),
                    He.splice(10));
            }
        ...
        function du(e) {
            ...
            return (
                ...
                () => {
                    var r;
                    return (r = t.value.find(
                        (n) => n != null && n.isConnected
                    )) != null
                        ? r
                        : null;
                }
        ...
        function pu({ ownerDocument: e, container: t, initialFocus: r }, n) {
            let i = vueExports.ref(null),
                s = vueExports.ref(false);
            return (
                vueExports.onMounted(() => (s.value = true)),
                vueExports.onUnmounted(() => (s.value = false)),
                vueExports.onMounted(() => {
                    vueExports.watch(
                        [t, r, n],
                        (a, o) => {
            ...
            Vi(
                ...
                (a) => {
                    ...
                    u && u instanceof HTMLElement
                        ? zi(o, u)
                            ? ((n.value = u), We(u))
                            : (a.preventDefault(), a.stopPropagation(), We(l))
                        : We(n.value);
                },
                true
            );
        ...
        let Sr = vueExports.defineComponent({
        ...
        let Xi = vueExports.defineComponent({
                name: "Portal",
                props: { as: { type: [Object, String], default: "div" } },
                setup(e, { slots: t, attrs: r }) {
                    let n = vueExports.ref(null),
                        i = vueExports.computed(() => Tt(n)),
                        s = mu(),
                        a = vueExports.inject(Ki, null),
                        o = vueExports.ref(
                            s === true || a == null
                                ? vu(n.value)
                                : a.resolveTarget()
                    ...
                    return (
                        ...
                        vueExports.onUnmounted(() => {
                            ...
                            c &&
                                ...
                                ((u = o.value.parentElement) == null ||
                                    u.removeChild(o.value));
                        }),
                        () => {
            ...
            gu = vueExports.defineComponent({
                ...
                setup(e, { attrs: t, slots: r }) {
                    let n = vueExports.reactive({
                        resolveTarget() {
                            return e.target;
                        },
                    });
                    return (
                        vueExports.provide(Ki, n),
                        () => {
                            let { target: i, ...s } = e;
                            return Z({
                                theirProps: s,
        ...
        function Su({
            ...
            return (
                ...
                vueExports.computed(() =>
                    n.value.length > 0 ? n.value.join(" ") : void 0
                )
            );
        }
        vueExports.defineComponent({
            ...
            props: {
                ...
                id: {
                    type: String,
                    default: () => `headlessui-description-${Ye()}`,
                },
            },
            setup(e, { attrs: t, slots: r }) {
                let n = wu();
                return (
                    vueExports.onMounted(() =>
                        vueExports.onUnmounted(n.register(e.id))
                    ),
                    () => {
                        let {
                                name: i = "Description",
                                slot: s = vueExports.ref({}),
                                props: a = {},
                            } = n,
                            { id: o, ...l } = e,
                            u = {
                ...
                t = {
                    addEventListener(r, n, i, s) {
                        return (
                            ...
                            t.add(() => r.removeEventListener(n, i, s))
                        );
                    },
        ...
        function Eu() {
            ...
            return {
                before({ doc: t }) {
                    ...
                    e =
                        ((r = t.defaultView) != null ? r : window).innerWidth -
                        n.clientWidth;
                },
                after({ doc: t, d: r }) {
                    let n = t.documentElement,
        ...
        let Ue = $u(() => /* @__PURE__ */ new Map(), {
            ...
            SCROLL_PREVENT({ doc: e, d: t, meta: r }) {
                let n = { doc: e, d: t, meta: _u(r) },
                    i = [Tu(), Eu(), xu()];
                i.forEach(({ before: s }) => (s == null ? void 0 : s(n))),
                    i.forEach(({ after: s }) => (s == null ? void 0 : s(n)));
            },
            SCROLL_ALLOW({ d: e }) {
                e.dispose();
            },
        ...
        Ue.subscribe(() => {
            ...
            for (let r of e.values()) {
                ...
                ((i && !n) || (!i && n)) &&
                    ...
                    r.count === 0 && Ue.dispatch("TEARDOWN", r);
            }
        });
        function Iu(e, t, r) {
            let n = Ou(Ue),
                i = vueExports.computed(() => {
        ...
        function xt(e) {
            ...
            if (t === null) {
                ...
                throw (
                    (Error.captureStackTrace && Error.captureStackTrace(r, xt),
                    r)
                );
            }
            return t;
        ...
        let qt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4",
            en = vueExports.defineComponent({
                ...
                setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
                    ...
                    let o = vueExports.ref(0),
                        l = Zr(),
                        u = vueExports.computed(() =>
                            e.open === qt && l !== null
                                ? (l.value & G.Open) === G.Open
                                : e.open
                        ),
                        c = vueExports.ref(null),
                        v = vueExports.ref(null),
                        g = vueExports.computed(() => Tt(c));
                    ...
                    if (typeof u.value != "boolean")
                        throw new Error(
                            `You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${
                                u.value === qt ? void 0 : e.open
                            }`
                        );
                    let f = vueExports.computed(() =>
                            a.value && u.value ? 0 : 1
                        ),
                        h = vueExports.computed(() => f.value === 0),
                        m = vueExports.computed(() => o.value > 1),
                        d = vueExports.inject($r, null) !== null,
                        b = vueExports.computed(() =>
                            m.value ? "parent" : "leaf"
                        ),
                        O = vueExports.computed(() =>
                            l !== null
                                ? (l.value & G.Closing) === G.Closing
                                : false
                        ),
                        A = vueExports.computed(() =>
                            d || O.value ? false : h.value
                        ),
                    ...
                    Fn(S, A);
                    let $ = vueExports.computed(() =>
                            m.value ? true : h.value
                        ),
                        w = vueExports.computed(() => {
                            var E, T, I;
                            return (I = Array.from(
                                (T =
                                    (E = g.value) == null
                                ...
                                (C) =>
                                    C.contains(D(v)) && C instanceof HTMLElement
                            )) != null
                                ? I
                                : null;
                        });
                    Fn(w, $),
                        bu({
                            type: "Dialog",
                            enabled: vueExports.computed(() => f.value === 0),
                            element: c,
                            onUpdate: (E, T) => {
                                if (T === "Dialog")
                                    return fe(E, {
                    ...
                    let _ = Su({
                            ...
                            slot: vueExports.computed(() => ({
                                open: u.value,
                            })),
                        }),
                        q = vueExports.ref(null),
                        P = {
                            titleId: q,
                            panelRef: vueExports.ref(null),
                            dialogState: f,
                            setTitleId(E) {
                                q.value !== E && (q.value = E);
                            },
                    ...
                    return (
                        ...
                        () => {
                            let { id: E, open: T, initialFocus: I, ...C } = e,
                                ...
                                U = { open: f.value === 0 };
                            return vueExports.h(Sr, { force: true }, () => [
                                vueExports.h(Xi, () =>
                                    vueExports.h(gu, { target: c.value }, () =>
                                        vueExports.h(Sr, { force: false }, () =>
                                            vueExports.h(
                                                pt,
                                                {
                                                    initialFocus: I,
        ...
        vueExports.defineComponent({
            ...
            props: {
                ...
                id: {
                    type: String,
                    default: () => `headlessui-dialog-overlay-${Ye()}`,
                },
            },
            setup(e, { attrs: t, slots: r }) {
                ...
                function i(s) {
                    s.target === s.currentTarget &&
                        (s.preventDefault(), s.stopPropagation(), n.close());
                }
                return () => {
                    let { id: s, ...a } = e;
                    return Z({
        ...
        vueExports.defineComponent({
            ...
            props: {
                ...
                id: {
                    type: String,
                    default: () => `headlessui-dialog-backdrop-${Ye()}`,
                },
            },
            inheritAttrs: false,
            setup(e, { attrs: t, slots: r, expose: n }) {
        ...
        let tn = vueExports.defineComponent({
            name: "DialogPanel",
            props: {
                as: { type: [Object, String], default: "div" },
                id: {
                    type: String,
                    default: () => `headlessui-dialog-panel-${Ye()}`,
                },
            },
            setup(e, { attrs: t, slots: r, expose: n }) {
        ...
        vueExports.defineComponent({
            ...
            props: {
                ...
                id: {
                    type: String,
                    default: () => `headlessui-dialog-title-${Ye()}`,
                },
            },
            setup(e, { attrs: t, slots: r }) {
                ...
                return (
                    vueExports.onMounted(() => {
                        n.setTitleId(e.id),
                            vueExports.onUnmounted(() => n.setTitleId(null));
                    }),
                    () => {
                        let { id: i, ...s } = e;
                        return Z({
        ...
        var Er = ((e) => (
            (e.Finished = "finished"), (e.Cancelled = "cancelled"), e
        ))(Er || {});
        function qu(e, t) {
            let r = Yt();
        ...
        var Cu = ((e) => ((e.Visible = "visible"), (e.Hidden = "hidden"), e))(
            Cu || {}
        );
        function Fu() {
        ...
        function Yi(e) {
            let t = vueExports.ref([]),
                r = vueExports.ref(false);
            vueExports.onMounted(() => (r.value = true)),
                vueExports.onUnmounted(() => (r.value = false));
        ...
        let Zi = Dt.RenderStrategy,
            lt = vueExports.defineComponent({
                ...
                setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
                    ...
                    let c = vueExports.ref(null),
                        v = vueExports.computed(() =>
                            e.unmount ? Ce.Unmount : Ce.Hidden
                        );
                    i({ el: c, $el: c });
                    let { show: g, appear: f } = ku(),
                        { register: h, unregister: m } = Lu(),
                        d = vueExports.ref(g.value ? "visible" : "hidden"),
                        b = { value: true },
                        O = Ye(),
                        A = { value: false },
                        S = Yi(() => {
            ...
            ut = vueExports.defineComponent({
                ...
                setup(e, { emit: t, attrs: r, slots: n }) {
                    ...
                    let a = vueExports.ref(s.value ? "visible" : "hidden"),
                        o = Yi(() => {
                            a.value = "hidden";
                        }),
                        l = vueExports.ref(true),
                        u = {
                            show: s,
                            appear: vueExports.computed(
                                () => e.appear || !l.value
                            ),
                        };
                    return (
                        ...
                        vueExports.provide(nn, o),
                        vueExports.provide(rn, u),
                        () => {
                            let c = Bi(e, [
                                    "show",
                                    "appear",
        ...
        const Bu = {
            ...
            computed: {
                ...
                title: function () {
                    var e;
                    return (e = p.confirmModal.value) != null && e.title
                        ? p.confirmModal.value.title
                        : this.defaultTitle;
                },
                text: function () {
                    var e;
                ...
                confirmButton: function () {
                    var e;
                    return (e = p.confirmModal.value) != null && e.confirmButton
                        ? p.confirmModal.value.confirmButton
                        : this.defaultConfirmButton;
                },
                cancelButton: function () {
                    var e;
                    return (e = p.confirmModal.value) != null && e.cancelButton
                        ? p.confirmModal.value.cancelButton
                        : this.defaultCancelButton;
                },
                confirmPassword: function () {
                    var e;
                    return (e = p.confirmModal.value) != null &&
                        e.confirmPassword
                        ? p.confirmModal.value.confirmPassword
                        : false;
                },
                confirmPasswordOnce: function () {
                    var e;
                    return (e = p.confirmModal.value) != null &&
                        e.confirmPasswordOnce
                        ? p.confirmModal.value.confirmPasswordOnce
                        : false;
                },
                confirmDanger: function () {
                    var e;
                    return (e = p.confirmModal.value) != null && e.confirmDanger
                        ? p.confirmModal.value.confirmDanger
                        : false;
                },
            },
            watch: {
            ...
            methods: {
                cancel() {
                    p.confirmModal.value.rejectPromise(),
                        ...
                        ne
                            ...
                            .catch((t) => {
                                t.response.status === 422
                                    ? (this.passwordError =
                                          t.response.data.errors.password[0])
                                    : (this.passwordError =
                ...
                handleSuccess(e) {
                    p.confirmModal.value.resolvePromise(e),
                        this.setIsOpen(false),
                        this.resetPassword();
                },
                async setIsOpen(e) {
                    if (e && this.confirmPassword && this.confirmPasswordOnce)
                        try {
                            if (
                                (
                                    await ne.get(
                                        this.confirmedPasswordStatusRoute
                                    )
                                ).status === 200
                            ) {
        ...
        function Nu(e, t, r) {
            var n = e[t];
            (!(Du.call(e, t) && Kr(n, r)) || (r === void 0 && !(t in e))) &&
                ts(e, t, r);
        }
        function Vu(e, t, r, n) {
            if (!J(e)) return e;
            ...
            rs = {
                ...
                setup(e) {
                    ...
                    return (
                        vueExports.onMounted(() => {
                            (r.value = (s) => {
                                n.value.children[0].contains(s.target) ||
                                    (t.ignoreInnerTargets &&
                                        n.value.contains(s.target)) ||
                                    t.do();
                            }),
        ...
        function it(e, t, r) {
            ...
            t &&
                re(e) &&
                ((i = (e.offsetWidth > 0 && nt(n.width) / e.offsetWidth) || 1),
                (s =
                    (e.offsetHeight > 0 && nt(n.height) / e.offsetHeight) ||
                    1));
        ...
        function lc(e, t, r) {
            ...
            return (
                (n || (!n && !r)) &&
                    ((pe(t) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
                        ln(s)) &&
                        (o = ac(t)),
                    re(t)
                        ? ((l = it(t, true)),
        ...
        function rr(e) {
            for (
                var t = Q(e), r = Bn(e);
                r && uc(r) && Ee(r).position === "static";

            )
                r = Bn(r);
            return r &&
                (pe(r) === "html" ||
                    (pe(r) === "body" && Ee(r).position === "static"))
                ? t
                : r || cc(e) || t;
        }
        var oe = "top",
        ...
        function Ac(e) {
            var t,
                ...
                l = -n.scrollTop;
            return (
                Ee(i || r).direction === "rtl" &&
                    (o += ze(r.clientWidth, i ? i.clientWidth : 0) - s),
                {
                    width: s,
                    height: a,
                    x: o,
        ...
        function cn(e, t) {
            ...
            var r = t,
                ...
                S = e.elements[h ? O : g],
                $ = Fc(
                    Xe(S) ? S : S.contextElement || je(e.elements.popper),
                    l,
                    c,
                    a
                ),
                                ...
                                if (Nn(O, A)) {
                                    (c.rects = {
                                        ...
                                        c.orderedModifiers.forEach(function (
                                            ...
                                            return (c.modifiersData[k.name] =
                                                Object.assign({}, k.data));
                                        });
                                    for (
                                        var S = 0;
                                        S < c.orderedModifiers.length;
                                        S++
                                    ) {
                                        if (c.reset === true) {
                                            (c.reset = false), (S = -1);
        ...
        function Vn(e) {
            ...
            if (u) {
                ...
                if (
                    (w === Q(r) &&
                        ((w = je(r)),
                        Ee(w).position !== "static" &&
                            o === "absolute" &&
                            ((_ = "scrollHeight"), (q = "scrollWidth"))),
                    (w = w),
                    i === oe || ((i === we || i === Re) && s === Ot))
                ) {
                    S = he;
            ...
            if (w) {
                if (s) {
                    var F,
                        ...
                        Me = Rt(0, _[I], Ae[I]),
                        sr = A
                            ? _[I] / 2 - ct - Me - dt - k.mainAxis
                            : It - Me - dt - k.mainAxis,
                        Ss = A
                            ? -_[I] / 2 + ct + Me + At + k.mainAxis
                            : Ie + Me + At + k.mainAxis,
                        ...
                        var ct = h ? 3 : 1,
                            It = function (Pe) {
                                var dt = S.find(function (At) {
                                    var Me = _.get(At);
                                    if (Me)
                                        return Me.slice(0, Pe).every(function (
                                            sr
                                        ) {
                                            return sr;
                                        });
        ...
        const sd = {
            ...
            ad = {
                ...
                mounted: async function () {
                    ...
                    const e = this.teleport
                        ? document.querySelector(
                              `div[data-splade-dropdown-id="${this.spladeId}"]`
                          )
        ...
        const ud = /* @__PURE__ */ _e(ad, [["render", ld]]),
            cd = {
                ...
                setup(e) {
                    const t = vueExports.inject("$splade") || {},
                        r = vueExports.inject("$spladeOptions") || {};
                    return (n, i) =>
                        vueExports.unref(t).isSsr
                            ? (vueExports.openBlock(),
                              vueExports.createBlock(
                                  ue,
                                  {
                                      ...
                                      html: vueExports
                                          .unref(t)
                                          .htmlForDynamicComponent(e.name),
                ...
                mounted() {
                    (this.subscription = this.private
                        ...
                        this.subscription
                            ? this.bindListeners()
                            : console.error(
                                  "[Splade Event component] Unable to subscribe to channel: " +
                                      this.channel
                              );
                },
                methods: {
        ...
        function ds(e, t, r, n, i, s) {
            ...
            for (s.set(e, t), s.set(t, e); ++v < o; ) {
                var h = e[v],
                    m = t[v];
                if (n) var d = a ? n(m, h, v, t, e, s) : n(h, m, v, e, t, s);
                if (d !== void 0) {
                    if (d) continue;
                    g = false;
                    break;
        ...
        function Vd(e, t, r, n, i, s, a) {
            switch (r) {
                ...
                case Dd:
                    return !(
                        e.byteLength != t.byteLength || !s(new Un(e), new Un(t))
                    );
                case qd:
                case Cd:
                case Ld:
        ...
        function pf(e, t, r, n, i, s) {
            ...
            if (g && !c)
                return (
                    s || (s = new Se()),
                    a || hi(e) ? ds(e, t, r, n, i, s) : Vd(e, t, l, r, n, i, s)
                );
            if (!(r & df)) {
                var f = c && ri.call(e, "__wrapped__"),
                    h = v && ri.call(t, "__wrapped__");
                if (f || h) {
                    var m = f ? e.value() : e,
                        d = h ? t.value() : t;
        ...
        const fn = Ff,
            kf = {
                ...
                mounted() {
                    this.inputElement =
                        this.$refs.file.querySelector('input[type="file"]');
                    const e = this.form[this.field];
                    (this.hadExistingFiles =
                        (this.multiple && e.length > 0) ||
                        (!this.multiple && e)),
                        this.form.$put(this.field, this.multiple ? [] : null),
                        this.filepond &&
                            (this.setExisting(e),
                            this.initFilepond(e || []).then(() => {
                                this.form.$registerFilepond(
                                    this.field,
                                    this.addFileToFilepond,
                                    this.addFilesToFilepond
                                );
                            }));
                },
                methods: {
                    ...
                    extractMetadataFromExistingFile(e) {
                        return e
                            ? se(e)
                                ? e
                                : M(e)
                                ? e.map(this.extractMetadataFromExistingFile)
                                : J(e)
                                ? e.options.metadata.metadata
                                : null
                            : null;
                    },
                    /**
                     ...
                     */
                    setExisting(e) {
                        this.handlesExistingFiles &&
                            (this.form.$put(
                                this.existingField,
                                this.extractMetadataFromExistingFile(e)
                            ),
                            this.setOrder());
                    },
                    /**
                    ...
                    setOrder() {
                        if (
                            ...
                            return;
                        const t = this.filepondInstance
                                .getFiles()
                                .filter((n) => !n.getMetadata("identifier")),
                            r = this.filepondInstance.getFiles().map((n) => {
                                const i = n.getMetadata("identifier");
                                return i
                                    ? "existing-file-" + i
                                    : "new-file-" + t.indexOf(n);
                            });
                    ...
                    initFilepond(e) {
                        ...
                        return new Promise((n) => {
                            import("filepond").then((i) => {
                                    ...
                                    r.jsFilepondOptions,
                                    {
                                        oninit() {
                                            const a = setInterval(() => {
                                                ...
                                                r.setOrder();
                                                const o =
                                                    r.filepondInstance.element.querySelector(
                                                        'input[type="file"]'
                                                    );
                                                o.hasAttribute("name") ||
                                                    o.setAttribute("name", t),
                                                    r.dusk &&
                                                        r.filepondInstance.element.setAttribute(
                                                            "dusk",
                                                            r.dusk
                                                        ),
                                                    o.setAttribute(
                                                    ...
                                                    r.multiple &&
                                                        r.filepondInstance.element.addEventListener(
                                                            "moveFile",
                                                            function (l) {
                                                                r.filepondInstance.moveFile(
                                                                    l.detail[0],
                                                                    l.detail[1]
                                                                ),
                                                                    r.setOrder();
                                ...
                                this.hadExistingFiles &&
                                    (s.files = this.multiple ? e : [e]),
                                    this.accept.length > 0 &&
                                        (s.acceptedFileTypes = this.accept),
                                    this.minFileSize &&
                                        (s.minFileSize = this.minFileSize),
                                    this.maxFileSize &&
                                        (s.maxFileSize = this.maxFileSize),
                                    this.minImageWidth &&
                                        (s.imageValidateSizeMinWidth =
                                            this.minImageWidth),
                                    this.maxImageWidth &&
                                        (s.imageValidateSizeMaxWidth =
                                            this.maxImageWidth),
                                    this.minImageHeight &&
                                        (s.imageValidateSizeMinHeight =
                                            this.minImageHeight),
                                    this.maxImageHeight &&
                                        (s.imageValidateSizeMaxHeight =
                                            this.maxImageHeight),
                                    this.minImageResolution &&
                                        (s.imageValidateSizeMinResolution =
                                            this.minImageResolution),
                                    this.maxImageResolution &&
                                        (s.imageValidateSizeMaxResolution =
                                            this.maxImageResolution),
                                    (s.server = {
                                    ...
                                    (s.itemInsertLocation === "before" ||
                                        s.itemInsertLocation === "after") &&
                                        (s.itemInsertLocationFreedom = false),
                                    this.loadFilepondPlugins(i).then((a) => {
                                        a.length > 0 &&
                                            i.registerPlugin(
                                                ...a.map((o) => o.default)
                                            ),
                                            (this.filepondInstance = i.create(
                                                this.inputElement,
                                                s
                                            ));
                                    });
...
`)
                ...
                mounted() {
                    let e = document.querySelector(
                        `form[data-splade-id="${this.spladeId}"]`
                    );
                    e || (e = document),
                        (this.formElement = e),
                ...
                methods: {
                    ...
                    $stopUploading(e) {
                        this.elementsUploading = this.elementsUploading.filter(
                            (t) => t != e[0]
                        );
                    },
                    hasError(e) {
                    ...
                    $fileAsUrl(e) {
                        ...
                        for (var i = "", s = 0; s < n.responseText.length; s++)
                            i += String.fromCharCode(
                                n.responseText.charCodeAt(s) & 255
                            );
                        return "data:" + t.type + ";base64," + btoa(i);
                    },
                    $errorAttributes(e) {
                        return {
                            [this.escapeValidationMessages
                                ? "textContent"
                                : "innerHTML"]: this.errors[e],
                        };
                    },
                    reset() {
                    ...
                    focusAndScrollToElement(e) {
                        let t = true;
                        if (
                            (e._flatpickr && (t = false),
                            e.tagName === "SELECT" &&
                                e.getAttribute("data-choice") &&
                                (t = false),
                            t)
                        ) {
                    ...
                    submit(e) {
                        if (this.$uploading) {
                            console.log(
                                "Not submitting because there are still files uploading"
                            );
                            return;
                        }
                        if (e) {
                    ...
                    async request(e) {
                        ...
                        const t =
                                this.values instanceof FormData
                                    ? this.values
                                    : pn(this.values),
                            r = {};
                        this.acceptHeader && (r.Accept = this.acceptHeader),
                            (this.stay || e) &&
                                (r["X-Splade-Prevent-Refresh"] = true),
                            this.preserveScroll &&
                                (r["X-Splade-Preserve-Scroll"] = true),
                            this.stack > 0 &&
                                this.keepModal &&
                                ((r["X-Splade-Modal"] = p.stackType(
                                    this.stack
                                )),
                                (r["X-Splade-Modal-Target"] = this.stack));
                        let n = this.method.toUpperCase();
                        n !== "GET" &&
                            n !== "POST" &&
                            (t.append("_method", n), (n = "POST"));
                        const i = (s) => {
                            this.$emit("success", s),
                        ...
                        p.request(
                            ...
                            .catch(async (s) => {
                                if (
                                    ...
                                    (this.recentlyUnsuccessfulTimeoutId =
                                        setTimeout(
                                            () =>
                                                (this.recentlyUnsuccessful = false),
                                            2e3
                                    ...
                                    return;
                                await this.$nextTick();
                                const a = fn(Object.keys(this.errors), (o) =>
                                    this.formElement.querySelector(
                                        `[data-validation-key="${o}"]`
                                    )
                                );
                                a &&
                                    this.focusAndScrollToElement(
                                        this.formElement.querySelector(
                                            `[data-validation-key="${a}"]`
                                        )
                                    );
                            });
                    },
                ...
                mounted() {
                    ...
                    import("jodit").then((t) => {
                        const r = Object.assign(
                            { defaultMode: t.default.Jodit.MODE_WYSIWYG },
                            this.options,
                            this.jsOptions
                        );
                        (this.instance = t.default.Jodit.make(e, r)),
                            (this.instance.value = this.modelValue),
                            this.instance.events.on("change", (n) =>
                                this.$emit("update:modelValue", n)
                            ),
                            this.dusk &&
                                this.instance.editor.setAttribute(
                                    "dusk",
                                    this.dusk
                                );
                    });
        ...
        function Jf(e, t, r, n, i, s) {
            ...
            return i.html
                ...
                : r.show
                ? vueExports.renderSlot(e.$slots, "default", { key: 1 })
                : vueExports.createCommentVNode("", true);
        }
        const Qf = /* @__PURE__ */ _e(Kf, [["render", Jf]]),
                ...
                setup(e) {
                    ...
                    function s() {
                        ...
                        if (et(t.href, "#")) {
                            if (p.openPreloadedModal(t.href.substring(1)))
                                return;
                            console.log(
                                "No preloaded modal found for " + t.href
                            );
                        }
                        ...
                        if (
                            (o &&
                                ((u["X-Splade-Modal"] = p.stackType(r)),
                                (u["X-Splade-Modal-Target"] = r)),
                            t.preserveScroll &&
                                (u["X-Splade-Preserve-Scroll"] = true),
                            l === "GET")
                        )
                            return t.replace
                                ? p.replace(t.href, u)
                                : p.visit(t.href, u);
                        const c =
                            t.data instanceof FormData ? t.data : pn(t.data);
                        l !== "POST" && (c.append("_method", l), (l = "POST")),
                            n.value &&
                                (c.append(
                                    se(t.requirePassword) && t.requirePassword
                                        ? t.requirePassword
                                        : "password",
                                    n.value
                                ),
                    ...
                    return (a, o) => (
                        ...
                        vueExports.createElementBlock(
                            ...
                            {
                                href: e.href,
                                onClick: vueExports.withModifiers(i, [
                                    "exact",
                                    "prevent",
                                ]),
                            },
            ...
            tp = {
                ...
                setup(e) {
                    const t = e;
                    return (
                        p.registerPreloadedModal(t.name, t.html, t.type),
                        t.opened && p.openPreloadedModal(t.name),
                        () => {}
                    );
                },
            },
        ...
        function np(e, t, r, n, i, s) {
            ...
            return i.html
                ...
                : i.loading
                ? vueExports.renderSlot(e.$slots, "placeholder", { key: 1 })
                : vueExports.renderSlot(e.$slots, "default", { key: 2 });
        }
        ...
        const op = {
                ...
                mounted() {
                    if (
                        ((this.element =
                            this.$refs.select.querySelector("select")),
                        this.choices)
                    )
                ...
                methods: {
                    async setOptionsFromRemote(e) {
                        this.destroyChoicesInstance();
                        let t = [];
                        this.placeholder && t.push(this.placeholder),
                            (t = this.normalizeOptions(e, t));
                        var r,
                    ...
                    destroyChoicesInstance() {
                        ...
                        this.choices &&
                            ...
                            this.selectShowDropdownListener &&
                                this.element.removeEventListener(
                                    "showDropdown",
                                    this.selectShowDropdownListener
                                ),
                    ...
                    getItemOfCurrentModel() {
                        ...
                        return fn(
                            this.choicesInstance._store.choices,
                            (t) => t.value == e
                        );
                    },
                    /*
                    ...
                    handlePlaceholderVisibility() {
                        ...
                        const e =
                            this.choicesInstance.containerInner.element.querySelector(
                                "input.choices__input"
                            );
                        this.placeholderText = e.placeholder
                            ? e.placeholder
                                    ...
                                    this.jsChoicesOptions,
                                    {
                                        callbackOnInit: function () {
                                            ...
                                            n.stack > 0 &&
                                                    ...
                                                    function (o) {
                                                        ...
                                                        const l =
                                                                n
                                                                    ...
                                                                    .isActive,
                                                            u =
                                                                n.choicesInstance.containerOuter.element.contains(
                                                                    o.target
                                                                );
                                                        !l && u
                                                            ? n.choicesInstance.showDropdown()
                                                            : l &&
                                                              !u &&
                                                              n.choicesInstance.hideDropdown();
                                                    }),
                                                document
                                                    .querySelector(
                                                        "#headlessui-portal-root"
                                                ...
                                                a.containerInner.element.setAttribute(
                                                    "data-select-name",
                                                    e.name
                                                ),
                                                e.hasAttribute("dusk") &&
                                                    e.removeAttribute("dusk"),
                                                n.dusk &&
                                                    (a.containerInner.element.setAttribute(
                                                        "dusk",
                                                        n.dusk
                                                    ),
                                                    a.choiceList.element.setAttribute(
                                                        "dusk",
                                                        `${n.dusk}-listbox`
                                                    )),
                                                (n.selectChangeListener =
                                                    function () {
                                                        let o =
                                                            a.getValue(true);
                                                        if (
                                                ...
                                                a.containerInner.element.addEventListener(
                                                    "hideDropdownFromDusk",
                                                    function () {
                                                        a.hideDropdown();
                                                    }
                                                ),
                                                (n.selectShowDropdownListener =
                                                    function () {
                                                        if (
                                                            n.multiple ||
                                                            !n.modelValue
                                                            ...
                                                            return;
                                                        const o =
                                                                n.getItemOfCurrentModel(),
                                                            l =
                                                                a.dropdown.element.querySelector(
                                                                    `.choices__item[data-id="${o.id}"]`
                                                                );
                                                        a.choiceList.scrollToChildElement(
                                                            l,
                                                            1
                                                        ),
                                                            a._highlightChoice(
...
`)
        ...
        const mp = {
                ...
                computed: {
                    ...
                    allVisibleItemsAreSelected() {
                        ...
                        return (
                            (e === 1 && this.selectedItems[0] === "*") ||
                            (e > 0 && e === this.itemsOnThisPage)
                        );
                    },
                    hasSelectedItems() {
                    ...
                    totalSelectedItems() {
                        const e = this.selectedItems.length;
                        return e === 1 && this.selectedItems[0] === "*"
                            ? this.itemsOnAllPages
                            : e;
                    },
                ...
                mounted() {
                    ...
                    te(e, (r, n) => {
                        ...
                        t.length === 0
                            ? (this.visibleColumns =
                                  this.defaultVisibleToggleableColumns)
                            : (this.visibleColumns = t),
                        p.restore(this.scrollToHeadRememberKey) &&
                            this.$nextTick(() => {
                                document
                                    .querySelector(
                                        `div[data-splade-id="${this.spladeId}"]`
                                    )
                                    .scrollIntoView({
                                        behavior: "smooth",
                                        block: "start",
                ...
                methods: {
                    navigate(e, t) {
                        ...
                        (this.paginationScroll !== "top" || !t) &&
                            (r["X-Splade-Preserve-Scroll"] = true),
                            p.request(e, "GET", {}, r, false).then(() => {
                                !p.isSsr &&
                                    this.paginationScroll === "head" &&
                                    t &&
                                    p.remember(
                                        this.scrollToHeadRememberKey,
                                        true
                                    );
                            });
                    },
                    visitLink(e, t, r) {
                        ...
                        if (
                            !(
                                ((n = r == null ? void 0 : r.target) == null
                                    ? void 0
                                    : n.tagName) === "A" ||
                                ((i = r == null ? void 0 : r.target) == null
                                    ? void 0
                                    : i.tagName) === "BUTTON"
                            )
                        )
                        ...
                        const t = !this.columnIsVisible(e),
                            r = hp(this.columns, (i) =>
                                i.can_be_hidden
                                    ? i.key === e
                                        ? t
                                        : this.visibleColumns.includes(i.key)
                                    : true
                            );
                    ...
                    disableSearchInput(e) {
                        (this.forcedVisibleSearchInputs =
                            this.forcedVisibleSearchInputs.filter(
                                (t) => t != e
                            )),
                            this.updateQuery(`filter[${e}]`, null);
                    },
                    /*
                    ...
                    showSearchInput(e) {
                        (this.forcedVisibleSearchInputs = [
                            ...
                            vueExports.nextTick(() => {
                                document
                                    .querySelector(`[name="searchInput-${e}"]`)
                                    .focus();
                            });
                    },
                    /*
                    ...
                    updateQuery(e, t, r, n) {
                        ...
                        (i[e] = t),
                            (et(e, "perPage") || et(e, "filter[")) &&
                                delete i.page,
                            this.visitWithQueryObject(i, r, n);
                    },
                ...
                render() {
                    return this.$slots.default({
                        ...
                        hasForcedVisibleSearchInputs:
                            this.hasForcedVisibleSearchInputs,
                        ...
                        allItemsFromAllPagesAreSelected:
                            this.allItemsFromAllPagesAreSelected,
                        allVisibleItemsAreSelected:
                            this.allVisibleItemsAreSelected,
        ...
        function gp(e, t, r, n, i, s) {
            return vueExports.withDirectives(
                (vueExports.openBlock(),
                vueExports.createBlock(
                    vueExports.resolveDynamicComponent(
                        i.isMounted ? i.Teleport : "div"
                    ),
                    vueExports.normalizeProps(
                        vueExports.guardReactiveProps(e.$attrs)
                    ),
                    {
                        default: vueExports.withCtx(() => [
                            vueExports.renderSlot(e.$slots, "default"),
        ...
        const yp = /* @__PURE__ */ _e(vp, [["render", gp]]),
            bp = {
                ...
                mounted() {
                    (this.element =
                        this.$refs.textarea.querySelector("textarea")),
                        this.autosize &&
                            import("autosize").then((e) => {
            ...
            Tp = {
                computed: {
                    ...
                    hasBackdrop: function () {
                        return (
                            p.toasts.value.filter(
                                (e) => !e.dismissed && e.backdrop && e.html
                            ).length > 0
                        );
                    },
                },
                        ...
                        this.methods.forEach((r) => {
                            t[r] = async (...n) => {
                                ...
                                try {
                                    ...
                                    this.$emit("error", s.response.data),
                                        p.onServerError(s.response.data);
                                    return;
                                }
                                return (
  ...
  `),
                ...
                init(e) {
                    ...
                    import("nprogress").then((r) => {
                        ...
                        document.addEventListener(
                            "splade:internal:request-progress",
                            (s) => t.progress(s, r.default)
                        ),
                            document.addEventListener(
                                "splade:internal:request-response",
                                (s) => i(s)
                            ),
                            document.addEventListener(
                                "splade:internal:request-error",
                                (s) => i(s)
                            ),
            ...
            Fp = {
                ...
                install: (e, t) => {
                    (t = t || {}),
                        (t.max_keep_alive = W(t, "max_keep_alive")
                            ? t.max_keep_alive
                            : 10),
                        (t.prefix = W(t, "prefix") ? t.prefix : "Splade"),
                        (t.transform_anchors = W(t, "transform_anchors")
                            ? t.transform_anchors
                            : false),
                        (t.link_component = W(t, "link_component")
                            ? t.link_component
                            : "Link"),
                        (t.progress_bar = W(t, "progress_bar")
                            ? t.progress_bar
                            : false),
                        (t.components = W(t, "components") ? t.components : {}),
                        (t.view_transitions = W(t, "view_transitions")
                            ? t.view_transitions
                            : false),
                        (t.suppress_compile_errors = W(
                            t,
                            "suppress_compile_errors"
                        )
                    ...
                    if (
                        ...
                        J(t.progress_bar) || (t.progress_bar = {}),
                            ["delay", "color", "css", "spinner"].forEach(
                                (i) => {
                                    W(t.progress_bar, i) ||
                                        (t.progress_bar[i] = n[i]);
                                }
                            ),
                    ...
                    t.suppress_compile_errors &&
                        (e.config.compilerOptions.onError = (n) => {
                            import(
                                "./assets/CompilerErrorMessages-6b34f14b-6b34f14b.js"
                            ).then((i) => {
                                console.error({
                                    message:
                                        i.default[n.code] ||
                    ...
                    s.on("data", (l) => (o += l)),
                        s.on("end", async () => {
                            ...
                            a.writeHead(200, {
                                ...
                                a.write(JSON.stringify({ body: c })),
                                a.end();
                        });
                }
            }).listen(i, () =>
                console.log(`Splade SSR server started on port ${i}.`)
            );
        }
