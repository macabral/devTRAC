<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <x-splade-button>
                <Link slideover href="{{ route('tipodocs.show', base64_encode(0)) }}">
                    {{ __('New Type') }}
                </Link>
            </x-splade-button>
        </div>
                    ...
                    @cell('action', $projs)
                        <div class="flex flex-row">
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('tipodocs.show', base64_encode($projs->id)) }}" title="{{ __('Edit') }}">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link  modal href="{{ route('tipodocs.delete', base64_encode($projs->id)) }}" title="{{ __('Delete') }}">
