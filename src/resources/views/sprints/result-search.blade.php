    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            @if (Session::get('ret')[0]['gp'] == '1')
                <x-splade-button>
                    <Link slideover href="{{ route('sprints.show', base64_encode(0)) }}" class="pc-4 py-2 text-white rounded-md">
                        {{ __('New Sprint') }}
                    </Link>
                </x-splade-button>
            @endif
        ...
        <div class="max-w-1xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <section>
                <x-splade-table :for="$ret" striped>
                    ...
                    @cell('desc', $ret)
                    <div>
                        <div class="mt-1 pb-2 pt-2" style="width: 10%;">
                    ...
                    @cell('action', $ret)
                        <div class="flex flex-row">
                            ...
                            <div class="basis-1/2 text-center">
                                <a href="{{ route('sprints.exports', base64_encode($ret->id)) }}" title="{{ __('Export Tickets') }}">
                            ...
                            @if (Session::get('ret')[0]['gp'] == '1')
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="basis-1/2 text-center">
                                    <Link modal href="{{ route('sprints.delete', base64_encode($ret->id)) }}" title="{{ __('Delete') }}">
