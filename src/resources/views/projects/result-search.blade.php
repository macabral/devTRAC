<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <x-splade-button>
                <Link slideover href="{{ route('projects.show', base64_encode(0)) }}" class="pc-4 py-2 text-white rounded-md">
                    {{ __('New Project') }}
                </Link>
            </x-splade-button>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-1xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <section>
                <x-splade-table :for="$projs" striped>
                    @cell('action', $projs)
                        <div class="flex flex-row">
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('projects.show', base64_encode($projs->id)) }}" title="{{ __('Edit') }}">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('projects.users', base64_encode($projs->id)) }}" title="{{ __('Users') }}">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link modal href="{{ route('projects.delete', base64_encode($projs->id)) }}" title="{{ __('Delete') }}">
