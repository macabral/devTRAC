            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background: #ffffff; border: 1px solid #eaebed; border-radius: 16px; width: 100%;" width="100%">
              ...
              <tr>
                <td class="wrapper" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; box-sizing: border-box; padding: 24px;" valign="top">
                  ...
                  <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;"> {{ __('You have been associated with the project with the following permissions:') }}</p>
                        ...
                        <td align="left" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; padding-bottom: 16px;" valign="top">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                            <tbody>
                              ...
                              <tr>
                                <td style="width:200px">{{ __('email') }}</td>
                                <td>{{ $data['email'] }}</td>
                              </tr>
                              <tr>
                                <td>&nbsp</td>
                              ...
                              <tr>
                                <td style="width:200px">{{ __('Relator') }}</td>
                                @IF($data['relator'] == '1')
                                    <td>*</td>
                                @else
                                    <td></td>
                              ...
                              <tr>
                                <td style="width:200px">{{ __('Developer') }}</td>
                                @IF($data['dev'] == '1')
                                    <td>*</td>
                                @else
                                    <td></td>
                              ...
                              <tr>
                                <td style="width:100px">{{ __('Tester') }}</td>
                                @IF($data['tester'] == '1')
                                    <td>*</td>
                                @else
                                    <td></td>
