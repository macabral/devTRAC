<x-guest-layout>
    <x-auth-card>
        <div>{{ __('After submitting your registration, an email will be sent to the Administrator to associate you with a project. Please wait until you receive a confirmation by email.') }}</div>
        <br>
