<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <x-splade-button>
                <Link slideover href="{{ route('typetickets.show', base64_encode(0)) }}" class="pc-4 py-2 bg-indigo-400 hover:bg-indigo-600 text-black rounded-md">
                    {{ __('New Type') }}
                </Link>
            </x-splade-button>
        </div>
                    ...
                    @cell('action', $projs)
                        <div class="flex flex-row">
                            <div class="basis-1/2 text-center">
                                <Link slideover href="{{ route('typetickets.show', base64_encode($projs->id)) }}" title="{{ __('Edit') }}">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="basis-1/2 text-center">
                                <Link  modal href="{{ route('typetickets.delete', base64_encode($projs->id)) }}" title="{{ __('Delete') }}">
