                ...
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-12 text-gray-600 dark:text-gray-400 text-lg">
                            {{ __("devTRAC is an issue tracking system for a small software development projects. It helps developers to view theirs tasks and interact with a Project Manager.") }}
                        </div>
                    </div>
                </div>
