                ...
                <x-splade-table :for="$ret" striped>
                    ...
                    <div>
                        <div class="mt-1 pb-2 pt-2 text-blue-800" style="width: 10%;">
                            {!! nl2br(wordwrap($ret->title, 100,'<br>',true)) !!}
                        </div>
                    </div>
                    @endcell
                    @cell('action', $ret)
                        <div class="flex flex-row">
                                ...
                                <div class="basis-1/2 text-center">
                                    <Link slideover href="{{ route('document-files.show', base64_encode($ret->id)), 'documents' }}" title="{{ __('Edit') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 -960 960 960" width="16"><path d="M460-80q-91 0-155.5-62.5T240-296v-430q0-64 45.5-109T395-880q65 0 110 45t45 110v394q0 38-26 64.5T460-240q-38 0-64-28.5T370-336v-392h40v395q0 22 14.5 37.5T460-280q21 0 35.5-15t14.5-36v-395q0-48-33.5-81T395-840q-48 0-81.5 33T280-726v432q0 73 53 123.5T460-120q75 0 127.5-51T640-296v-432h40v431q0 91-64.5 154T460-80Z"/></svg>                                    </Link>
                                </div>
